...
CREATE TABLE purchase_payment_plan(
    ...
    late_fee_flat_charge REAL NOT NULL,
    late_fee_percentage_charge REAL NOT NULL
);

ALTER TABLE purchase_payment_plan 
ADD CONSTRAINT fk_purchase_payment_plan_purchase FOREIGN KEY (purchase_id) 
REFERENCES purchase (purchase_id),
ADD CONSTRAINT fk_purchase_payment_status FOREIGN KEY (payment_plan_status_id) 
REFERENCES purchase_payment_plan_status (payment_plan_status_id);
...
REFERENCES purchase (purchase_id),
ADD CONSTRAINT fk_purchase_payment_status FOREIGN KEY (payment_status_id) 
REFERENCES purchase_payment_status (payment_status_id);
...
ADD CONSTRAINT fk_purchase_late_fee_payment_purchase_payment FOREIGN KEY (purchase_payment_id) 
REFERENCES purchase_payment (purchase_payment_id),
ADD CONSTRAINT fk_purchase_late_fee_payment_status FOREIGN KEY (late_fee_payment_status_id) 
REFERENCES purchase_late_fee_payment_status (late_fee_payment_status_id);