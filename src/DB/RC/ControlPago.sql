...
ALTER TABLE ONLY delay
ADD CONSTRAINT pk_delay PRIMARY KEY (delay_id);
...
ALTER TABLE ONLY delay
    ADD CONSTRAINT fk_delay_pending_fee FOREIGN KEY (pending_fee) REFERENCES pending_fee;
	
ALTER TABLE ONLY delay
    ADD CONSTRAINT fk_delay_pending_fee FOREIGN KEY (pending_fee) REFERENCES pending_fee;

ALTER TABLE ONLY advance
	ADD CONSTRAINT fk_advance_loan FOREIGN KEY (loan_id) REFERENCES loan;
